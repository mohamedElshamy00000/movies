...
Route::prefix('dashboard')->group(function () {
    ...
    Route::get('/showMovie', [App\Http\Controllers\backend\MovieController::class, 'showMovie'])->name('dashboard.showMovie');
    
    // import from file
    Route::post('/movies/import', [App\Http\Controllers\backend\MovieController::class, 'importMovie'])->name('dashboard.excel.import');
